...
# --------------------------------------------------------------------------- #
# here is a second attempt with a standardization on X and a
...
# --------------------------------------------------------------------------- #
# here is a third attempt where we include quadratic data as well, again with a
# logarithmic transformation on y
...
table[rev(order(table$validationMSE)),]    # x and x^2 are a package deal (both or neither)
                                           # for simplicity, we ignore yr0fPts this time
...
# --------------------------------------------------------------------------- #
# here is our final attempt.  We will include only the best predictors, and 
