...
public class ScoreSubmitServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		TestSet ts = tsu.getTestSet(course);//��ȡ�Ծ�������Ϣ
		float singleTotal = 0;//��ѡ���ܷ�
		float multiplyTotal = 0;//��ѡ���ܷ�
		float judgeTotal = 0;//�ж����ܷ�
		float jdTotal = 0;//������ܷ�
		float programTotal=0;//������ܷ�
		float total=0;
		
		for(int i=0;i<ts.getSinChCount();i++)//��ȡ��ѡ�����
		{
		...
		for(int i=0;i<ts.getMulChCount();i++)//��ȡ��ѡ�����
		{
		...
		for(int i=0;i<ts.getJudgeCount();i++)//��ȡ�ж������
		{
