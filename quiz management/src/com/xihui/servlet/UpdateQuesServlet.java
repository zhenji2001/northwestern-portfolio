...
public class UpdateQuesServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		PrintWriter out = response.getWriter();
		int Qid = Integer.parseInt(request.getParameter("hi_Qid").trim());
		String kemu = request.getParameter("kemu").trim();
		String ch_course = "course"+kemu;
		String course = new String(request.getParameter(ch_course).getBytes("iso8859-1"),"gbk").trim();
		int type = Integer.parseInt(request.getParameter("type").trim());
		String ques = new String(request.getParameter("ques").getBytes("iso8859-1"),"gbk").trim();
		String keyA = null;
		String keyB = null;
		String keyC = null;
		String keyD = null;
		...
		{
			answer = request.getParameter("answer_jud").trim();
		}else//����⣬�����
		{
		...
		boolean success = qu.updateQuestion(question);
		if(success)
		{
